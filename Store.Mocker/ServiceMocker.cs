    ...
    public static class ServiceMocker
    {
        ...
        public static IHumanResourcesService GetHumanResourcesService()
        {
           ...
           .Options;
            ...
            return new HumanResourcesService(LogHelper.GetLogger<HumanResourcesService>(), new UserInfo { Name = "mocker" }, new StoreDbContext(options), new myProductDBContext(myPoptions));
        }
        ...
        public static IProductionService GetProductionService()
        {
           ...
           .Options;
            ...
            return new ProductionService(LogHelper.GetLogger<ProductionService>(), new UserInfo { Name = "mocker" }, new StoreDbContext(options), new myProductDBContext(myPoptions));
        }
        ...
        public static ISalesService GetSalesService()
        {
           ...
           .Options;
            ...
            return new SalesService(LogHelper.GetLogger<SalesService>(), new UserInfo { Name = "mocker" }, new StoreDbContext(options), new myProductDBContext(myPoptions));
        }
